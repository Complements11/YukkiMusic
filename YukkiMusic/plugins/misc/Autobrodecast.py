...
from YukkiMusic.utils.database import get_served_chats, get_served_users
from config import LOG_GROUP_ID
from pyrogram.types import InlineKeyboardMarkup, InlineKeyboardButton

AUTO_GCASTS = True
AUTO_GCAST = True
START_IMG_URLS = "https://envs.sh/pEc.jpg"
...
BUTTONS = InlineKeyboardMarkup([[InlineKeyboardButton("𝙰𝚍𝚍 𝙼𝚎", url=f"https://t.me/ToLuMusicBot?startgroup=true")]])
